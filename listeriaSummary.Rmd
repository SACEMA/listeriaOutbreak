...
curve(1-pgamma(x,exp(coef(estIncGamma)[1])*exp(coef(estIncGamma)[2]),exp(coef(estIncGamma)[2])),add=T,lwd=3,col='darkgreen')
points(exp(coef(estIncGamma)[1]),1.1,pch=21,cex=1.1,xpd=T,col='darkgreen',lwd=3)
...
abline(v=3.5+seq(0,28,7),col='red',lty=3)
```
